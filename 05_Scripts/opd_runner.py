...
w("[2.1] MK13 API top-up (เติมวันล่าสุดที่ Sheet ยังไม่มี — ต้องรันหลัง opd_pull ไม่งั้นโดนเขียนทับ)...")
...
w(f"  {'OK' if ok2d else 'FAIL'} upsell_pull.py")
